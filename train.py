...
###############################################
WE_ARE_HIRING = "ARTEM.VORONIN@DEEPLANCERS.COM"
###############################################

PATH_TO_WORK_DIR = "/Users/artem/Downloads/"
...
def main():
    ...
    train_loader = torch.utils.data.DataLoader(
        datasets.ImageFolder(TRAIN_PATH, TRAIN_TRANSFORMS),
        batch_size=BATCH_SIZE,
        shuffle=True
    )
    print("Create test_loader")
    test_loader = torch.utils.data.DataLoader(
        datasets.ImageFolder(TEST_PATH, TEST_TRANSFORMS),
        batch_size=1,
        shuffle=True
    )
